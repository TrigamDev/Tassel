...
public class TasselEnchantmentScreenHandler extends ScreenHandler {
	...
	private final Inventory inventory = new SimpleInventory(2) {
		...
		public void markDirty() {
			super.markDirty();
			TasselEnchantmentScreenHandler.this.onContentChanged(this);
		}
	};
	private List<Enchantment> availableEnchantments = Lists.newArrayList();

	public TasselEnchantmentScreenHandler(int syncId, PlayerInventory playerInventory) {
		this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
	}
	public TasselEnchantmentScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
		super(TasselScreenHandlers.MOD_ENCHANTMENT_SCREEN_HANDLER, syncId);
